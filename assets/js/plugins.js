  ...
  var m = {
    ...
    callback: function (T) {
      ...
      if (r) {
        ...
        while (E < O.length) {
          if (
            O[E].getElementsByClassName("timeline-Tweet-retweetCredit").length >
            0
          ) {
            A.push(true);
          } else {
      ...
      if (a) {
        while (L < E) {
          N.push({
            ...
            author_data: {
              profile_url: S[L]
                ? S[L].querySelector('[data-scribe="element:user_link"]').href
                : null,
              profile_image: S[L]
                ? S[L].querySelector(
                ...
                : null,
              profile_image_2x: S[L]
                ? S[L].querySelector(
                    '[data-scribe="element:avatar"]'
                  ).getAttribute("data-src-2x")
                : null,
              screen_name: S[L]
                ? S[L].querySelector('[data-scribe="element:screen_name"]')
                    .title
                : null,
              name: S[L]
                ? S[L].querySelector('[data-scribe="element:name"]').title
                : null,
            },
            time: F[L].textContent,
            timestamp: F[L].getAttribute("datetime")
              .replace("+0000", "Z")
